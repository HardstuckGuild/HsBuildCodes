...
class TraitLineChoices implements \ArrayAccess {
	public TraitLineChoice $Adept       = TraitLineChoice::NONE;
	public TraitLineChoice $Master      = TraitLineChoice::NONE;
	public TraitLineChoice $Grandmaster = TraitLineChoice::NONE;

	/** @param int $offset */
	public function offsetGet(mixed $offset) : TraitLineChoice
	{
		return match ($offset) {
			0 => $this->Adept,
			1 => $this->Master,
