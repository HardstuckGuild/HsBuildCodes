...
class FunctionTests extends TestCase {
	...
	public const UMLAUT_KEY = "D95CE863-D1B6-284F-B347-4B66C993759EDD490996-37AE-4E71-839A-DA51A0B6D40B";
...
class BasicCodesTests extends TestCase {
	...
	/** @test */
	public function LoadCharacterWithUmlaut()
	{
		$code = APILoader::LoadBuildCode(FunctionTests::UMLAUT_KEY, "Brönski Van Gönski", Kind::PvE);
	}
